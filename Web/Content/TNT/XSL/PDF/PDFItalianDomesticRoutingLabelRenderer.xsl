...
<xsl:template name="ItalianDomesticPdf">
	...
	<fo:block-container break-before="page" 
	     ...
	     <fo:block-container absolute-position="absolute"
		     ...
		     <fo:block font-size="8pt">L.V.</fo:block>
		     <fo:block font-weight="bold"
		               font-size="18pt"
		               line-height="100%"> 
	     ...
	     <fo:block-container absolute-position="absolute"
	                         ...
	                         border-bottom-width="1px"
	                         border-bottom-style="solid">
		     <fo:block font-size="8px" color="#FFFFFF">Opzione</fo:block>
	     ...
	     <fo:block-container absolute-position="absolute"
	                         ...
	                         line-height="90%">
		     <fo:block>
		       <fo:inline font-size="7pt">Mitt: </fo:inline>
		       <fo:inline font-size="10pt"><xsl:value-of select="../consignmentLabelData/contact/name" /></fo:inline> 
		     </fo:block> 
	         <fo:block>
	           <fo:inline font-size="7pt">Rif.Cli.: </fo:inline>
	           <fo:inline font-size="10pt"><xsl:value-of select="pieceReference" /></fo:inline> 
	         </fo:block> 
	         <fo:block>
	           <fo:inline font-size="7pt">Codica Cliente Mittente</fo:inline>
	           <fo:inline font-size="10pt"><xsl:value-of select="../consignmentLabelData/account/accountNumber" /></fo:inline> 
	         </fo:block>
	     </fo:block-container> 
	     ...
	     <fo:block-container absolute-position="absolute"
                             ...
                             line-height="60%"> 
		     <fo:block>
		        <fo:inline font-size="8px" vertical-align="top">Filiali Partenza</fo:inline>                                    
	         </fo:block>                                     
	         <fo:block> 
	     ...
	     <fo:block-container absolute-position="absolute"
	                         ...
	                         width="63px"
	                         height="25px">
		     <fo:block font-size="8px" >Data Partenza</fo:block> 
	     ...
	     <fo:block-container absolute-position="absolute"
	                         ...
	                         border-left-style="solid"
	                         border-right-style="solid">
		     <fo:block font-size="8px">Indirizzo di consegna</fo:block>
	     ...
	     <fo:block-container absolute-position="absolute"
		     ...
		     <fo:block font-size="8px">Instradamento</fo:block>
	     </fo:block-container> 
	     ...
	     <fo:block-container absolute-position="absolute"
	                         ...
	                         line-height="80%">
		     <fo:block>
		         <fo:inline font-size="20px" font-weight="bold" padding-left="15px">
        ...
        <fo:block-container absolute-position="absolute"
	     ...
	     <fo:block-container absolute-position="absolute"
	                         ...
	                         border-width="1px"
	                         border-bottom-style="solid">
		     <fo:block font-size="8px">Filiali</fo:block>
		     <fo:block font-size="8px">Arrivo</fo:block> 
	     </fo:block-container> 
